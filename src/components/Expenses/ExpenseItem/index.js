   ...
   render() {
      return (
        ...
        <tr>
            <th>{this.props.index + 1}</th>
            <td>
                <input type="date" className={"form-control form-control-sm"} name="date" onChange={this.handleChange} defaultValue={this.props.expense.date} />
            </td>
            <td>
                <input type="text" className={"form-control form-control-sm"} name="text" onChange={this.handleChange} placeholder="Please write a description" defaultValue={this.props.expense.text} />
            </td>
            <td>
